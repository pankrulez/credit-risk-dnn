...
export default function InsightsTab() {
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in duration-500">
      ...
      {/* Top Row: ROC and PR Curves (Stacks on mobile, side-by-side on desktop) */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-[#1c1b19] p-4 md:p-6 rounded-2xl md:rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm flex flex-col">
          <h3 className="text-base md:text-lg font-bold text-slate-800 dark:text-slate-100 mb-4">ROC Curve (AUC = 0.78)</h3>
        ...
        <div className="bg-white dark:bg-[#1c1b19] p-4 md:p-6 rounded-2xl md:rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm flex flex-col">
          <h3 className="text-base md:text-lg font-bold text-slate-800 dark:text-slate-100 mb-4">Precision-Recall Curve</h3>
          <div className="h-[250px] md:h-[300px] w-full flex-grow">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="bg-white dark:bg-[#1c1b19] p-4 md:p-6 rounded-2xl md:rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm">
        <h3 className="text-base md:text-lg font-bold text-slate-800 dark:text-slate-100 mb-2">Global Feature Importance (SHAP)</h3>
